...
In order to configure these redirects you can use [env vars](/documentation/environment-variables), or the [installation tool](/documentation/command-line-interface/installation-tool), which will ask you for those values.
