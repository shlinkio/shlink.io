...
* The [installation tool](http://localhost:3000/documentation/command-line-interface/installation-tool/), which will, at some point, ask you if you want to integrate with redis, and request you to provide all the capabilities above if so.
