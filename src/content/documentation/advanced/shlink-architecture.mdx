...
Some of those decisions are sometimes hard to understand, specially when coming from other services, like YOURLS or Bit.ly
...
This could represent a typical architecture in which Shlink could be integrated.
...
* Any potential UI or consumer app (like [shlink-web-client](/documentation/shlink-web-client)) can have its own independent release lifecycle.
...
* If shlink-web-client covers your needs as a web UI, you can just forget about maintaining your own instance and use https://app.shlink.io
