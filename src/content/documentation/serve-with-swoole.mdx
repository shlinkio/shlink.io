...
In order to use swoole, you have to install the swoole PHP extension using Pecl: `pecl install swoole-4.5.5`.
...
* Using an HTTPS certificate that keeps your users' data safe.
