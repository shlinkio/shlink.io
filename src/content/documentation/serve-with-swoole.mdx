...
<Callout type="info">
  Shlink v3.0.0 supports only openswoole, and no longer regular swoole. However, the functionality does not currently deviate too much, so regular swoole will continue to be detected as openswoole for the time being.
  <br />
