...
They provide a non-blocking I/O server, similar to the one used for node.js applications, which lets web apps to be run once and kept in memory while serving requests.
