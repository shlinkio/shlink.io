...
<Callout type="info">
  Starting with Shlink 2.9.0, you can customize the default configuration for QR codes via <Link href="/documentation/command-line-interface/installation-tool">installation tool</Link> or <Link href="/documentation/environment-variables">env vars</Link>.
</Callout>
