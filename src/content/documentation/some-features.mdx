...
<Callout type="info">
  Starting with Shlink 2.9.0, you can customize the default configuration for QR codes via <Link href="/documentation/install-dist-file/#installation-steps">installer tool</Link> or <Link href="/documentation/environment-variables">env vars</Link>.
</Callout>
