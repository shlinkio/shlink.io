...
<Callout type="warning" title="Important">
  ...
  If your Shlink instance is out of date, preferably, update Shlink in sequential order using the latest minor release for each update. For example, from version 3.2.1 to reach version 3.4.0, first update to 3.3.2 before updating to 3.4.0.
</Callout>
