...
If you are hosting Shlink manually, whether it is served with swoole or not, you probably started by running the `cli/install` helper tool, which gets your instance set-up.
