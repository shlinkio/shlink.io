...
If you are hosting Shlink manually, whether it is served with openswoole or not, you probably started by running the `cli/install` helper tool, which gets your instance set-up.
