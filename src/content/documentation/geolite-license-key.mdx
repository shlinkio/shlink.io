...
* Via [installer tool](/documentation/command-line-interface/installer-tool): you will be asked to provide the license key when installing or updating Shlink, or you can use [set-option](/documentation/command-line-interface/installer-tool#set-option) to set it later.
