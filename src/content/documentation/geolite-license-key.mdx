...
* Via installer tool: you will be asked to provide the license key when installing or updating Shlink, or you can run `vendor/bin/shlink-installer set-option` to set it later.
