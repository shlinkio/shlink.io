...
* The next PHP extensions: json, curl, pdo, intl, gd and gmp/bcmath.
    ...
    * sockets and bcmath extensions are required if you want to integrate with a RabbitMQ instance, or use [RoadRunner](https://roadrunner.dev/) to serve Shlink.
...
* The [openswoole](https://openswoole.com/) PHP extension (if you plan to serve Shlink with openswoole). See other ways to [serve Shlink](/documentation/supported-runtimes/).
...
* Configure your system to be able to serve Shlink:
    * [Serve Shlink using openswoole](/documentation/serve-with-openswoole).
