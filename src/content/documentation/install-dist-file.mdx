...
* The [swoole/openswoole](https://www.swoole.co.uk/) PHP extension (if you plan to serve Shlink with swoole) or the web server of your choice with PHP integration (like Apache or Nginx).

### Installation steps

* Download the latest distributable file and decompress it at the location of your choice (you will find a pair of dist files for every supported PHP version, one for swoole and one for non-swoole contexts).
...
* Configure your system to be able to serve Shlink:
    * [Serve Shlink using swoole or openswoole](/documentation/serve-with-swoole).
