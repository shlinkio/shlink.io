...
* Set up and customize Shlink by either:
    * Running the [installer tool](/documentation/command-line-interface/installer-tool) (`vendor/bin/shlink-installer install`). It's an interactive tool that will guide you through the installation process.
