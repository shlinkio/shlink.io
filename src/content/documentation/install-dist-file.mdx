...
* One of the [supported runtimes](/documentation/supported-runtimes/) properly set-up:
  * [Serve Shlink using openswoole](/documentation/supported-runtimes/serve-with-openswoole/).
