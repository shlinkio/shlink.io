...
* Set up and customize Shlink by either:
    * Running the `bin/install` script. It will guide you through an interactive installation process.
    * Providing your configuration via [env vars](/documentation/environment-variables).
