...
Depending on your setup, visits could be geolocated almost in real time (if you [serve Shlink with openswoole](/documentation/serve-with-swoole) or use the [docker image](/documentation/install-docker-image)), or you will have to configure a [scheduled task](/documentation/long-running-tasks#locate-visits) that does it.
