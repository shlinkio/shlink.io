...
It works similarly to node.js and [openswoole](/documentation/supported-runtimes/serve-with-openswoole/), and is currently the **officially recommended runtime**.
