...
It can be either one server name or a comma-separated list of servers. Make sure to include the port number. For example:

```
REDIS_SERVERS=shlink.abcd.cache.amazonaws.com:6379
```
