...
> The integration with mercure is available since Shlink **v2.2.0**. More information can be found [here](/documentation/real-time-updates#mercure-hub-server).
...
* `GEOLITE_LICENSE_KEY`: The license key used to download new GeoLite2 database files. This is not mandatory, as a default license key is provided, but it is **strongly recommended** that you provide your own. Go to [GeoLite2 license key](/documentation/geolite-license-key) to know how to generate it.
