...
The docker image is probably the simplest installation use case, since it includes all dependencies and makes use of [openswoole](https://www.swoole.co.uk/) to serve Shlink.
...
docker run \
    ...
    -e DEFAULT_QR_CODE_SIZE=500 \
    -e DEFAULT_QR_CODE_MARGIN=10 \
    -e DEFAULT_QR_CODE_FORMAT=svg \
    -e DEFAULT_QR_CODE_ERROR_CORRECTION=H \
    shlinkio/shlink:stable
```
