...
* Shlink also supports providing configuration options via the so-called [installer tool](/documentation/command-line-interface/installer-tool). This is an interactive CLI tool that generates some "hardcoded" configuration after being executed.
