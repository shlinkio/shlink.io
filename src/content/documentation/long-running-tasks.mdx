...
> When serving Shlink [with openswoole](/documentation/serve-with-swoole), locating visits is automatically done just after redirecting end users. However, it might be a good idea to have previous scheduling in place, as a backup in case some of those asynchronous processes fail.
>
