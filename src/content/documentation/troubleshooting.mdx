...
When you install Shlink using the [installer tool](/documentation/command-line-interface/installer-tool), you will be able to easily provide all the config options.
...
In any case, you will need to have some kind of shell access in order to run the [installer tool](/documentation/command-line-interface/installer-tool).
...
However, when running the [install](/documentation/command-line-interface/installer-tool#install) or [update](/documentation/command-line-interface/installer-tool#update) scripts you see syntax errors.
