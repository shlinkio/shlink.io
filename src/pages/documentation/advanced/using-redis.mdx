...
* Credentials, that can be provided as part of the server URIs, either both [username and password](https://redis.io/docs/management/security/acl/) (`tcp://the_username:the_password@my_redis_server:6379`) or [just password](https://redis.io/docs/management/security/) (`tcp://:the_password@my_redis_server:6379`).
