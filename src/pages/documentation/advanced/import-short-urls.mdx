...
- [Bitly](/documentation/advanced/import-short-urls#bitly) _(since Shlink v2.4.0)_
- [YOURLS](/documentation/advanced/import-short-urls#yourls) _(since Shlink v2.10.0)_
- [Standard CSV](/documentation/advanced/import-short-urls#standard-csv) _(since Shlink v2.6.0)_
- [Shlink instance](/documentation/advanced/import-short-urls#shlink-instance) _(since Shlink v2.7.0)_
- [Kutt.it](/documentation/advanced/import-short-urls#kuttit) _(since Shlink v3.1.0)_
...
<Callout type="warning">
  YOURLS' API does not expose enough actions for Shlink to fetch all data. Because of that, you first need to install
  the <code className="indivisible">yourls-shlink-import-plugin</code> in YOURLS itself. You can download it from{' '}
  <Link href="https://slnk.to/yourls-import">its repository</Link> and follow the instructions there.
</Callout>
...
Shlink allows importing short URLs, and optionally visits, from a self-hosted kutt instance, or the SaaS https://kutt.to, using its API.
