...
<Callout type="warning" title="Important!">
  ...
  <p>
    However, it's still <b>up to you</b> to properly configure the DNS and web server, so that all the domains point to
    the proper "place", and the requests end up in Shlink. Shlink will never be able to do this on its own.
  </p>
  If you want to learn more about this aspect, go to{' '}
  <Link href="/documentation/advanced/multiple-domains/#external-configuration">External configuration</Link>.
</Callout>
