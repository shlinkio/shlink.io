...
<Callout type="warning">
  Bear in mind that Shlink will not check if a specific visit already exists in Matomo. All visits matching provided
  dates will be sent, which could cause duplications.
</Callout>
