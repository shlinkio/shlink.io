...
* Credentials, that can be provided as part of the server URIs (whether they are redis instances or sentinels):
    ...
    * Separately via config or env vars, when using sentinels and redis instances have their own auth.
