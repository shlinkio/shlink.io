...
|                                                                              | <img src="/images/logos/roadrunner.png" width="25" className="d-inline me-1" /> RoadRunner | Classic web server                                           |
|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| **Performance**                                                              | <span className="text-success">90</span>                                                   | <span className="text-danger">30</span>                      |
| **Stability under heavy load**                                               | <span className="text-success">100</span>                                                  | <span className="text-warning">70</span>                     |
| **Hard to install**                                                          | <span className="text-success">Easy</span>                                                 | Medium                                                       |
| **[Reverse proxy](/documentation/advanced/exposing-through-reverse-proxy/)** | Recommended                                                                                | <span className="text-success">Not needed</span>             |
| **HTTPS support**                                                            | Via reverse proxy                                                                          | Yes                                                          |
| **[Real-time updates](/documentation/advanced/real-time-updates/)**          | <FontAwesomeIcon icon={faCheck} className="text-success" /> <RTULimitationTooltip />       | <FontAwesomeIcon icon={faXmark} className="text-danger" />   |
| **GeoLite2 updates**                                                         | <FontAwesomeIcon icon={faCheck} className="text-success" />                                | Via [long-running tasks](/documentation/long-running-tasks/) |
