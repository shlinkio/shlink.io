      ...
      <div className="container">
        <div className="row justify-content-center">
          ...
          <Feature
            ...
            link="/documentation/some-features/#device-specific-redirects"
          >
            Dynamically redirect to different places depending on the visitor, like the App Store for iPhone, or a
